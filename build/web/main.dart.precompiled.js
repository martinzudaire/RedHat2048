...
["GridCoordinates", "grid_coordinates.dart", , G, {
  "^": "",
  GridCoordinates: {
    "^": "Object;x,y"
  }
}],
["GridIterator", "grid_iterator.dart", , T, {
  "^": "",
  GridIterator0: {
    "^": "Object;_GridIterator$_grid,_direction,_row,_cell",
    getGridCoordinates$0: function() {
      var t1, t2, t3;
      t1 = this._direction;
      t2 = $.get$Move_left();
      if (t1 == null ? t2 == null : t1 === t2) {
        t1 = this._row;
        t2 = this._cell;
        t3 = new G.GridCoordinates(null, null);
        t3.x = t1;
        t3.y = t2;
        return t3;
      } else {
      ...
      t1 = new G.GridCoordinates(null, null);
      t1.x = -1;
      t1.y = -1;
      return t1;
    },
    GridIterator$2: function(grid, direction) {
      this._GridIterator$_grid = grid;
      this._direction = direction;
      this._row = 0;
      this._cell = 0;
    },
    static: {GridIterator$: function(grid, direction) {
        var t1 = new T.GridIterator0(null, null, null, null);
        t1.GridIterator$2(grid, direction);
        return t1;
      }}
  }
}],
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _IsolateContext: {
    ...
    handleUncaughtError$2: function(error, stackTrace) {
      ...
      for (t2 = new P.LinkedHashSetIterator(t1, t1._modifications, null, null), t2._collection$_cell = t1._first; t2.moveNext$0();)
...
["button_new_game", "button_new_game.dart", , R, {
  "^": "",
  ButtonNewGame: {
    "^": "Object;",
    notify$0: function() {
    },
    ButtonNewGame$0: function() {
      var t1 = J.get$onMouseUp$x(document.querySelector("#new_game_button_id"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.ButtonNewGame_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {ButtonNewGame$: function() {
        var t1 = new R.ButtonNewGame();
        t1.ButtonNewGame$0();
        return t1;
      }}
  },
  ButtonNewGame_closure: {
    "^": "Closure:12;",
    call$1: function(e) {
      var t1, t2;
      if (J.get$checked$x(document.querySelector("#client_side_game_id")) === true) {
        t1 = $.get$Game__instance();
        t2 = t1.webRequest;
        t2.removeObserver$1(t1);
        t2 = B.GameLogic$();
        t1.webRequest = t2;
        t2.addObserver$1(t1);
      } else {
...
["dart.collection", "dart:collection", , P, {
  ...
  LinkedHashMapKeyIterable: {
    ...
    get$iterator: function(_) {
      ...
      t2._collection$_cell = t1._first;
      return t2;
    },
    forEach$1: function(_, f) {
  ...
  LinkedHashMapKeyIterator: {
    "^": "Object;_map,_modifications,_collection$_cell,_collection$_current",
    get$current: function() {
      return this._collection$_current;
    },
    moveNext$0: function() {
      ...
      if (this._modifications !== t1._modifications)
        ...
        if (t1 == null) {
          ...
          this._collection$_cell = this._collection$_cell.get$_next();
          return true;
        }
      }
    }
  ...
  _LinkedHashSet: {
    ...
    get$iterator: function(_) {
      ...
      t1._collection$_cell = this._first;
      return t1;
    },
    get$length: function(_) {
      return this._collection$_length;
  ...
  LinkedHashSetIterator: {
    "^": "Object;_set,_modifications,_collection$_cell,_collection$_current",
    get$current: function() {
      return this._collection$_current;
    },
    moveNext$0: function() {
...
["game", "game.dart", , Q, {
  "^": "",
  Game: {
    "^": "Object;webRequest,webRequestServer,webRequestClient,_currentGameState,_playersTurn,_listObservers",
    notify$0: function() {
      var t1 = this.webRequest.getGameState$0();
      if (t1 != null)
        this._currentGameState = t1;
      this._notifyObservers$0();
      this._playersTurn = true;
      return;
    },
    _notifyObservers$0: function() {
      for (var t1 = this._listObservers, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.notify$0();
    },
    Game$_internal$0: function() {
      this.webRequest = Z.WebRequest$();
      this._currentGameState = N.GameState$();
      this._playersTurn = false;
      this._listObservers = H.setRuntimeTypeInfo([], [E.Observer]);
      this.webRequest.addObserver$1(this);
    },
    static: {"^": "Game__instance"}
  }
}],
["game_logic", "game_logic.dart", , B, {
  "^": "",
  GameLogic: {
    "^": "Object;_random,_game_logic$_lastGameState,_game_logic$_listObservers",
    getFirstState$0: function() {
      var gameState = N.GameState$();
      this._addRandomNumberToGrid$1(gameState._game_state$_grid);
      this._addRandomNumberToGrid$1(gameState._game_state$_grid);
      this._game_logic$_lastGameState = gameState;
      this.notifyObservers$0();
    },
    postMove$1: function(move) {
      var gs = this._processGameStateHelper$2(this._game_logic$_lastGameState.clone$0(0), move);
      this._addRandomNumberToGrid$1(gs._game_state$_grid);
      this._game_logic$_lastGameState = N.GameState$fromJSON(gs._game_state$_grid, gs._score, gs._points, gs._moves, gs._moved, this.isGameOver$1(gs), gs._won);
      this.notifyObservers$0();
    },
    getGameState$0: function() {
      return this._game_logic$_lastGameState;
    },
    addObserver$1: function(o) {
      this._game_logic$_listObservers.push(o);
    },
    removeObserver$1: function(o) {
      C.JSArray_methods.remove$1(this._game_logic$_listObservers, o);
    },
    notifyObservers$0: function() {
      for (var t1 = this._game_logic$_listObservers, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.notify$0();
    },
    _simulateMove$2: function(gameState, move) {
      var gs = this._processGameStateHelper$2(gameState.clone$0(0), move);
      return N.GameState$fromJSON(gs._game_state$_grid, gs._score, gs._points, gs._moves, gs._moved, this.isGameOver$1(gs), gs._won);
    },
    _processGameStateHelper$2: function(gameState, move) {
      var iterator, iteratorHelper, moved, won, points, t1, c, t2, t3, t4, t5, t6;
      iterator = T.GridIterator$(gameState._game_state$_grid, move);
      iteratorHelper = T.GridIterator$(gameState._game_state$_grid, move);
      moved = false;
      won = false;
      points = 0;
      while (true) {
        ...
        iterator._cell = t1;
        for (; t1 <= 3;) {
          c = iterator.getGridCoordinates$0();
          if (J.$eq(iterator._GridIterator$_grid.getValueXY$2(c.x, c.y), 0)) {
            t1 = iterator._cell;
            if (typeof t1 !== "number")
              return t1.$add();
            ++t1;
            ...
            c = iterator.getGridCoordinates$0();
            t1 = iterator._GridIterator$_grid.getValueXY$2(c.x, c.y);
            c = iteratorHelper.getGridCoordinates$0();
            if (J.$eq(t1, iteratorHelper._GridIterator$_grid.getValueXY$2(c.x, c.y))) {
              c = iteratorHelper.getGridCoordinates$0();
              if (J.$eq(J.$mul$ns(iteratorHelper._GridIterator$_grid.getValueXY$2(c.x, c.y), 2), 2048))
                won = true;
              c = iteratorHelper.getGridCoordinates$0();
              t1 = J.$mul$ns(iteratorHelper._GridIterator$_grid.getValueXY$2(c.x, c.y), 2);
              if (typeof t1 !== "number")
                return H.iae(t1);
              points += t1;
              c = iteratorHelper.getGridCoordinates$0();
              t1 = J.$mul$ns(iteratorHelper._GridIterator$_grid.getValueXY$2(c.x, c.y), 2);
              c = iteratorHelper.getGridCoordinates$0();
              t2 = iteratorHelper._GridIterator$_grid;
              t3 = c.x;
              t4 = c.y;
              if (typeof t3 !== "number")
                return t3.$ge();
              ...
              t1 = iteratorHelper._cell;
              if (typeof t1 !== "number")
                return t1.$add();
              iteratorHelper._cell = t1 + 1;
              c = iterator.getGridCoordinates$0();
              t1 = iterator._GridIterator$_grid;
              t2 = c.x;
              t3 = c.y;
              if (typeof t2 !== "number")
                return t2.$ge();
              ...
              c = iteratorHelper.getGridCoordinates$0();
              if (!J.$eq(iteratorHelper._GridIterator$_grid.getValueXY$2(c.x, c.y), 0)) {
                t1 = iteratorHelper._cell;
                if (typeof t1 !== "number")
                  return t1.$add();
                iteratorHelper._cell = t1 + 1;
        ...
        iterator._row = t1 + 1;
        iterator._cell = 0;
        t1 = iteratorHelper._row;
        if (typeof t1 !== "number")
          return t1.$add();
        iteratorHelper._row = t1 + 1;
        iteratorHelper._cell = 0;
      }
      return N.GameState$fromJSON(gameState._game_state$_grid, J.$add$ns(gameState._score, points), points, J.$add$ns(gameState._moves, 1), moved, false, won);
    },
    isGameOver$1: function(gameState) {
      var gsLeft, gsRight, gsUp, gsDown, t1;
      gsLeft = this._processGameStateHelper$2(gameState.clone$0(0), $.get$Move_left());
      gsRight = this._processGameStateHelper$2(gameState.clone$0(0), $.get$Move_right());
      gsUp = this._processGameStateHelper$2(gameState.clone$0(0), $.get$Move_up());
      gsDown = this._processGameStateHelper$2(gameState.clone$0(0), $.get$Move_down());
      if (!gameState._won)
        t1 = !(gsLeft._moved || gsRight._moved || gsUp._moved || gsDown._moved);
      else
        t1 = true;
      return t1;
    },
    _addRandomNumberToGrid$1: function(grid) {
      var numberOfEmptyCells, iterator, randomCell, emptyCell, t1, c, t2, t3, t4, t5, t6;
      numberOfEmptyCells = this._getNumberOfEmptyCells$1(grid);
      if (numberOfEmptyCells <= 0)
        return;
      iterator = T.GridIterator$(grid, $.get$Move_left());
      randomCell = this._random.nextInt$1(numberOfEmptyCells) + 1;
      emptyCell = 0;
      while (true) {
        t1 = iterator._row;
        if (typeof t1 !== "number")
          return t1.$gt();
        if (!(t1 <= 3 && emptyCell !== randomCell))
          break;
        while (true) {
          t1 = iterator._cell;
          if (typeof t1 !== "number")
          ...
          if (emptyCell === randomCell) {
            t1 = this._random.nextDouble$0() < 0.9 ? 2 : 4;
            c = iterator.getGridCoordinates$0();
            t2 = iterator._GridIterator$_grid;
            t3 = c.x;
            t4 = c.y;
            if (typeof t3 !== "number")
              return t3.$ge();
    ...
    _getNumberOfEmptyCells$1: function(grid) {
      var iterator, emptyCells, t1, c;
      iterator = T.GridIterator$(grid, $.get$Move_left());
      emptyCells = 0;
      while (true) {
        t1 = iterator._row;
    ...
    GameLogic$0: function() {
      this._random = C.C__JSRandom;
      this._game_logic$_lastGameState = N.GameState$();
      this._game_logic$_listObservers = H.setRuntimeTypeInfo([], [E.Observer]);
    },
    static: {GameLogic$: function() {
        var t1 = new B.GameLogic(null, null, null);
        t1.GameLogic$0();
        return t1;
      }}
  }
}],
["game_over_view", "game_over_view.dart", , O, {
  "^": "",
  GameOverView: {
    "^": "Object;",
    notify$0: function() {
      var gs = $.get$Game__instance()._currentGameState;
      if (gs._won) {
        J.set$display$x(document.querySelector("#you_win_id").style, "block");
        J.set$display$x(document.querySelector("#game_over_id").style, "none");
      } else if (gs._over) {
        J.set$display$x(document.querySelector("#you_win_id").style, "none");
        J.set$display$x(document.querySelector("#game_over_id").style, "block");
      } else {
        J.set$display$x(document.querySelector("#you_win_id").style, "none");
        J.set$display$x(document.querySelector("#game_over_id").style, "none");
      }
...
["game_solver", "game_solver.dart", , V, {
  "^": "",
  GameSolver: {
    "^": "Object;",
    notify$0: function() {
      if (!$.get$Game__instance()._currentGameState._over)
        this.move$0();
    }
  }
}],
["game_state", "game_state.dart", , N, {
  "^": "",
  GameState: {
    "^": "Object;_game_state$_grid,_score,_points,_moves,_moved,_over,_won",
    clone$0: function(_) {
      var t1 = new S.Grid(null);
      t1._grid = this._game_state$_grid._grid.clone$0(0);
      return N.GameState$fromJSON(t1, this._score, this._points, this._moves, this._moved, this._over, this._won);
    },
    GameState$fromJSON$7: function(grid, score, points, moves, moved, over, won) {
      this._game_state$_grid = grid;
      this._score = score;
      this._points = points;
      this._moves = moves;
      this._moved = moved;
    ...
    GameState$0: function() {
      var t1 = new S.Grid(null);
      t1._grid = T.Matrix$(4, 4);
      this._game_state$_grid = t1;
      this._score = 0;
      this._points = 0;
      this._moves = 0;
      this._moved = false;
    ...
    static: {GameState$: function() {
        var t1 = new N.GameState(null, null, null, null, null, null, null);
        t1.GameState$0();
        return t1;
      }, GameState$fromJSON: function(grid, score, points, moves, moved, over, won) {
        var t1 = new N.GameState(null, null, null, null, null, null, null);
        t1.GameState$fromJSON$7(grid, score, points, moves, moved, over, won);
        return t1;
      }}
  }
}],
["grid", "grid.dart", , S, {
  ...
  Grid: {
    "^": "Object;_grid",
    getValueXY$2: function(x, y) {
      if (!this.isOutOfBoundsXY$2(x, y))
        return this._grid.getValue$2(x, y);
      else
        return -1;
    },
    isOutOfBoundsXY$2: function(x, y) {
      var t1;
      if (typeof x !== "number")
        return x.$ge();
      if (x >= 0)
...
["grid_view", "grid_view.dart", , E, {
  "^": "",
  GridView: {
    "^": "Object;",
    notify$0: function() {
      var g, i, j, t1;
      g = $.get$Game__instance()._currentGameState._game_state$_grid;
      for (i = 0; i < 4; ++i)
        for (j = 0; j < 4; ++j) {
          t1 = "#gridcell_" + C.JSInt_methods.toString$0(i) + "_" + C.JSInt_methods.toString$0(j) + "_id";
          document.querySelector(t1).textContent = J.toString$0(g.getValueXY$2(i, j));
        }
    }
  }
}],
...
["", "main.dart", , F, {
  ...
  main: [function() {
    R.ButtonNewGame$();
    var t1 = $.get$Game__instance();
    t1.toString;
    t1._listObservers.push(new E.GridView());
    t1.toString;
    t1._listObservers.push(new G.ScoreView());
    t1.toString;
    t1._listObservers.push(new Y.PointsView());
    t1.toString;
    t1._listObservers.push(new K.MovesView());
    t1.toString;
    t1._listObservers.push(new O.GameOverView());
    t1.toString;
    t1._listObservers.push(new V.SolverDecrecimiento(null));
    t1.webRequest.getFirstState$0();
  }, "call$0", "main$closure", 0, 0, 2]
},
1],
["matrix", "matrix.dart", , T, {
  "^": "",
  Matrix: {
    "^": "Object;_array,_sizeX,_sizeY",
    getValue$2: function(x, y) {
      var t1;
      if (typeof x !== "number")
        return x.$ge();
      if (x >= 0)
    ...
    setValue$3: function(x, y, value) {
      var t1;
      if (!this.isOutOfBounds$2(x, y)) {
        t1 = this._array;
    ...
    clone$0: function(_) {
      var mat, i, j, t1, t2;
      mat = T.Matrix$(this._sizeX, this._sizeY);
      for (i = 0; i < this._sizeX; ++i)
        for (j = 0; j < this._sizeY; ++j) {
          t1 = this.getValue$2(i, j);
          if (i < mat._sizeX)
            t2 = j < mat._sizeY;
          else
            t2 = false;
    ...
    Matrix$2: function(sizeX, sizeY) {
      var i, list, j;
      this._array = H.setRuntimeTypeInfo([], [[P.List, P.$int]]);
      this._sizeX = sizeX;
      this._sizeY = sizeY;
      for (i = 0; i < sizeX; ++i) {
        list = [];
        ...
        for (j = 0; j < sizeY; ++j)
          list.push(0);
        this._array.push(list);
      }
    },
    static: {Matrix$: function(sizeX, sizeY) {
        var t1 = new T.Matrix(null, null, null);
        t1.Matrix$2(sizeX, sizeY);
        return t1;
      }, Matrix_parseMatrix: function(text, sizeX, sizeY) {
        var matrix, t1, start, end, i, j, t2, t3;
        matrix = T.Matrix$(sizeX, sizeY);
        for (t1 = text.length, start = 1, end = null, i = 0; i < sizeX; ++i) {
          for (j = 0; j < sizeY; ++j) {
            end = start;
            while (true) {
              if (end < 0 || end >= t1)
                return H.ioore(text, end);
              t2 = text[end];
              if (!(t2 !== "," && t2 !== "]"))
                break;
              ++end;
            }
            t2 = H.Primitives_parseInt(C.JSString_methods.substring$2(text, start, end), null, null);
            if (i < matrix._sizeX)
              t3 = j < matrix._sizeY;
            else
              t3 = false;
...
["move", "move.dart", , T, {
  "^": "",
  Move: {
    "^": "Object;_move$_value,_directionX,_directionY",
    toString$0: function(_) {
      return C.JSInt_methods.toString$0(this._move$_value);
    },
    static: {"^": "Move_up,Move_right,Move_down,Move_left"}
  }
}],
["moves_view", "moves_view.dart", , K, {
  "^": "",
  MovesView: {
    "^": "Object;",
    notify$0: function() {
      var gs = $.get$Game__instance()._currentGameState;
      document.querySelector("#moves_id").textContent = C.JSString_methods.$add("Moves: ", J.toString$0(gs._moves));
    }
  }
}],
["observer", "observer.dart", , E, {
  "^": "",
  Observer: {
    "^": "Object;"
  }
}],
["points_view", "points_view.dart", , Y, {
  "^": "",
  PointsView: {
    "^": "Object;",
    notify$0: function() {
      var gs = $.get$Game__instance()._currentGameState;
      document.querySelector("#points_id").textContent = C.JSString_methods.$add("Points: ", J.toString$0(gs._points));
    }
  }
}],
["score_view", "score_view.dart", , G, {
  "^": "",
  ScoreView: {
    "^": "Object;",
    notify$0: function() {
      var gs = $.get$Game__instance()._currentGameState;
      document.querySelector("#score_id").textContent = C.JSString_methods.$add("Score: ", J.toString$0(gs._score));
    }
  }
}],
["solver_decrecimiento", "solver_decrecimiento.dart", , V, {
  "^": "",
  SolverDecrecimiento: {
    "^": "GameSolver;_globalMove",
    move$0: function() {
      var t1, gameState, t2, cellHighestValue;
      t1 = $.get$Game__instance();
      gameState = t1._currentGameState;
      t2 = new S.Grid(null);
      t2._grid = gameState._game_state$_grid._grid.clone$0(0);
      cellHighestValue = this.findCellWithHighestValue$1(t2);
      this._globalMove = null;
      if (!this.isCornered$1(cellHighestValue))
        this._globalMove = this.pushToCorner$1(gameState);
      if (this._globalMove == null)
        this.calculateMove$4(gameState, cellHighestValue, 3, H.setRuntimeTypeInfo([], [T.Move]));
      t2 = this._globalMove;
      t1.webRequest.postMove$1(t2);
      t1._playersTurn = false;
    },
    pushToCorner$1: function(gameState) {
      var gameLogic, t1;
      gameLogic = B.GameLogic$();
      t1 = $.get$Move_up();
      if (this.isCornered$1(this.findCellWithHighestValue$1(gameLogic._simulateMove$2(gameState, t1)._game_state$_grid)))
        return t1;
      t1 = $.get$Move_down();
      if (this.isCornered$1(this.findCellWithHighestValue$1(gameLogic._simulateMove$2(gameState, t1)._game_state$_grid)))
        return t1;
    ...
    calculateMove$4: function(gameState, cellHighestValue, depth, prevMoves) {
      var decrecimientos, moveList, depthList, returnList, gameLogic, t1, gs, t2, aux, newPrevMoves, temp, t3, max, i, t4;
      decrecimientos = H.setRuntimeTypeInfo([], [P.$int]);
      moveList = H.setRuntimeTypeInfo([], [T.Move]);
      depthList = H.setRuntimeTypeInfo([], [P.$int]);
      returnList = H.setRuntimeTypeInfo([], [P.$int]);
      gameLogic = B.GameLogic$();
      t1 = $.get$Move_up();
      gs = gameLogic._simulateMove$2(gameState, t1);
      t2 = $.get$Move_down();
      if (!C.JSArray_methods.contains$1(prevMoves, t2) && gs._moved) {
        aux = this.calculateMaxCount$4(gs._game_state$_grid, cellHighestValue, null, false);
        decrecimientos.push(aux);
        moveList.push(t1);
        depthList.push(depth);
        if (depth !== 0 && aux !== 0) {
          newPrevMoves = this.cloneListMove$1(prevMoves);
          newPrevMoves.push(t1);
          temp = this.calculateMove$4(gs, cellHighestValue, depth - 1, newPrevMoves);
          if (0 >= temp.length)
            return H.ioore(temp, 0);
          t3 = temp[0];
          if (t3 !== -1) {
            decrecimientos.push(t3);
            moveList.push(t1);
            if (1 >= temp.length)
              return H.ioore(temp, 1);
            depthList.push(temp[1]);
          }
        }
      }
      gs = gameLogic._simulateMove$2(gameState, t2);
      if (!C.JSArray_methods.contains$1(prevMoves, t1) && gs._moved) {
        aux = this.calculateMaxCount$4(gs._game_state$_grid, cellHighestValue, null, false);
        decrecimientos.push(aux);
        moveList.push(t2);
        depthList.push(depth);
        if (depth !== 0 && aux !== 0) {
          newPrevMoves = this.cloneListMove$1(prevMoves);
          newPrevMoves.push(t2);
          temp = this.calculateMove$4(gs, cellHighestValue, depth - 1, newPrevMoves);
          if (0 >= temp.length)
            return H.ioore(temp, 0);
          t1 = temp[0];
          if (t1 !== -1) {
            decrecimientos.push(t1);
            moveList.push(t2);
            if (1 >= temp.length)
              return H.ioore(temp, 1);
            depthList.push(temp[1]);
      ...
      t1 = decrecimientos.length;
      if (t1 > 0) {
        for (t2 = depthList.length, max = 0, i = 1; i < t1; ++i) {
          t3 = decrecimientos[i];
          if (max < 0 || max >= t1)
            return H.ioore(decrecimientos, max);
          t4 = decrecimientos[max];
          if (t3 > t4)
            max = i;
          else if (t3 === t4) {
            if (i >= t2)
              return H.ioore(depthList, i);
            t3 = depthList[i];
            if (max >= t2)
              return H.ioore(depthList, max);
            if (t3 > depthList[max])
              max = i;
          }
        }
        if (max < 0 || max >= moveList.length)
          return H.ioore(moveList, max);
        this._globalMove = moveList[max];
        if (max >= decrecimientos.length)
          return H.ioore(decrecimientos, max);
        returnList.push(decrecimientos[max]);
        if (max >= depthList.length)
          return H.ioore(depthList, max);
        returnList.push(depthList[max]);
      } else {
        returnList.push(-1);
        returnList.push(depth);
      }
      return returnList;
    },
    calculateMaxCount$4: function(grid, cell, zigzagDirection, breakZigZag) {
      var addedcount, t1, maxcount, i, t2;
      addedcount = H.setRuntimeTypeInfo([], [P.$int]);
      if (J.$eq(grid.getValueXY$2(cell.x, cell.y), 0))
        return 0;
      addedcount.push(this.calculateMaxCountHelper$5(grid, cell, $.get$Move_down(), zigzagDirection, breakZigZag));
      addedcount.push(this.calculateMaxCountHelper$5(grid, cell, $.get$Move_up(), zigzagDirection, breakZigZag));
      addedcount.push(this.calculateMaxCountHelper$5(grid, cell, $.get$Move_right(), zigzagDirection, breakZigZag));
      addedcount.push(this.calculateMaxCountHelper$5(grid, cell, $.get$Move_left(), zigzagDirection, breakZigZag));
      for (t1 = addedcount.length, maxcount = 0, i = 1; i < t1; ++i) {
        t2 = addedcount[i];
        if (maxcount < 0 || maxcount >= t1)
          return H.ioore(addedcount, maxcount);
        if (t2 > addedcount[maxcount])
          maxcount = i;
      }
      if (maxcount < 0 || maxcount >= t1)
        return H.ioore(addedcount, maxcount);
    ...
    calculateMaxCountHelper$5: function(grid, cell, direction, zigzagDirection, breakZigZag) {
      var t1, t2, t3, nextCell, isZigZagBroken, cellValue, count, returnCount;
      t1 = cell.x;
      t2 = direction._directionX;
      if (typeof t1 !== "number")
        return t1.$add();
      t2 = t1 + t2;
      t1 = cell.y;
      t3 = direction._directionY;
      if (typeof t1 !== "number")
        return t1.$add();
      t3 = t1 + t3;
      nextCell = new G.GridCoordinates(null, null);
      nextCell.x = t2;
      nextCell.y = t3;
      if (!grid.isOutOfBoundsXY$2(t2, t3) && J.$ge$n(grid.getValueXY$2(cell.x, cell.y), grid.getValueXY$2(t2, t3))) {
        if (zigzagDirection == null)
          zigzagDirection = direction;
        isZigZagBroken = breakZigZag || (zigzagDirection == null ? direction != null : zigzagDirection !== direction);
        cellValue = grid.getValueXY$2(cell.x, cell.y);
        t1 = cell.x;
        t2 = cell.y;
        if (!grid.isOutOfBoundsXY$2(t1, t2))
          grid._grid.setValue$3(t1, t2, 1000000);
        count = this.calculateMaxCount$4(grid, nextCell, zigzagDirection, isZigZagBroken);
        t1 = J.$mul$ns(cellValue, this.calculateFactor$4(direction, zigzagDirection, cell, breakZigZag));
        if (typeof t1 !== "number")
          return H.iae(t1);
        returnCount = count + t1;
        t1 = cell.x;
        t2 = cell.y;
        if (!grid.isOutOfBoundsXY$2(t1, t2))
          grid._grid.setValue$3(t1, t2, cellValue);
        if (J.$eq(grid.getValueXY$2(cell.x, cell.y), grid.getValueXY$2(nextCell.x, nextCell.y)))
          --returnCount;
      } else
        returnCount = 0;
      return returnCount;
    },
    findCellWithHighestValue$1: function(grid) {
      var iterator, coordinates, t1, c;
      iterator = T.GridIterator$(grid, $.get$Move_right());
      coordinates = null;
      while (true) {
        t1 = iterator._row;
        if (typeof t1 !== "number")
        ...
        while (true) {
          ...
          if (!(t1 <= 3))
            break;
          c = iterator.getGridCoordinates$0();
          if (J.$gt$n(iterator._GridIterator$_grid.getValueXY$2(c.x, c.y), 0))
            coordinates = iterator.getGridCoordinates$0();
          else {
            c = iterator.getGridCoordinates$0();
            if (J.$eq(iterator._GridIterator$_grid.getValueXY$2(c.x, c.y), 0)) {
              c = iterator.getGridCoordinates$0();
    ...
    isCornered$1: function(coordinates) {
      var t1 = coordinates.x;
      if (t1 === 0 || t1 === 3) {
        t1 = coordinates.y;
        t1 = t1 === 0 || t1 === 3;
      } else
    ...
    cloneListMove$1: function(moves) {
      var list, i;
      list = H.setRuntimeTypeInfo([], [T.Move]);
      for (i = 0; i < moves.length; ++i)
        list.push(moves[i]);
      return list;
    },
    calculateFactor$4: function(direction, zigzagDirection, cell, breakZigZag) {
      if (breakZigZag)
        return 1;
      else if (this.isCornered$1(cell))
        return 2;
      else if (direction == null ? zigzagDirection == null : direction === zigzagDirection)
        return 2;
      else
        return 1;
    }
...
["web_request", "web_request.dart", , Z, {
  "^": "",
  WebRequest: {
    "^": "Object;_sessionId,_lastGameState,_web_request$_listObservers",
    getFirstState$0: function() {
      W.HttpRequest_getString($.WebRequest_start_url, null, null).then$1(new Z.WebRequest_getFirstState_closure(this)).catchError$1(new Z.WebRequest_getFirstState_closure0());
    },
    postMove$1: function(move) {
      W.HttpRequest_getString(C.JSString_methods.$add($.WebRequest_state_url, this._sessionId) + "/move/" + J.toString$0(move) + "/json", null, null).then$1(new Z.WebRequest_postMove_closure(this)).catchError$1(new Z.WebRequest_postMove_closure0());
    },
    getGameState$0: function() {
      return this._lastGameState;
    },
    addObserver$1: function(o) {
      this._web_request$_listObservers.push(o);
    },
    removeObserver$1: function(o) {
      C.JSArray_methods.remove$1(this._web_request$_listObservers, o);
    },
    notifyObservers$0: function() {
      for (var t1 = this._web_request$_listObservers, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.notify$0();
    },
    _processData$1: function(data) {
      var t1, end, grid, start, score, points, t2, t3, t4, moves;
      for (t1 = J.getInterceptor$asx(data), end = 9; !J.$eq(t1.$index(data, end), "\""); ++end)
        ;
      grid = new S.Grid(null);
      grid._grid = T.Matrix_parseMatrix(t1.substring$2(data, 9, end - 2) + ",", 4, 4);
      t1 = data.length;
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
        if (!(data[start] !== ":"))
          break;
        ++start;
      }
      ...
      while (true) {
        if (end >= t1)
          return H.ioore(data, end);
        if (!(data[end] !== ","))
          break;
        ++end;
      }
      score = H.Primitives_parseInt(C.JSString_methods.substring$2(data, start + 1, end), null, null);
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
      ...
      points = H.Primitives_parseInt(C.JSString_methods.substring$2(data, start + 1, end), null, null);
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
      ...
      t2 = C.JSString_methods.substring$2(data, start + 1, end);
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
      ...
      t3 = C.JSString_methods.substring$2(data, start + 1, end);
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
      ...
      t4 = C.JSString_methods.substring$2(data, start + 1, end);
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
      ...
      moves = H.Primitives_parseInt(C.JSString_methods.substring$2(data, start + 1, end), null, null);
      start = end;
      while (true) {
        if (start >= t1)
          return H.ioore(data, start);
      ...
      this._sessionId = C.JSString_methods.substring$2(data, start + 2, end - 1);
      this._lastGameState = N.GameState$fromJSON(grid, score, points, moves, t2 === "true", t3 === "true", t4 === "true");
      this.notifyObservers$0();
    },
    WebRequest$0: function() {
      this._sessionId = null;
      this._lastGameState = null;
      this._web_request$_listObservers = H.setRuntimeTypeInfo([], [E.Observer]);
    },
    static: {"^": "WebRequest_start_url,WebRequest_state_url", WebRequest$: function() {
        var t1 = new Z.WebRequest(null, null, null);
        t1.WebRequest$0();
        return t1;
      }}
  },
  WebRequest_getFirstState_closure: {
    "^": "Closure:0;this_0",
    call$1: function(fileContents) {
      this.this_0._processData$1(fileContents);
    },
    $isFunction: true
  },
  WebRequest_getFirstState_closure0: {
    "^": "Closure:22;",
    call$1: function(error) {
...
;(function() {
  ...
  E.Observer.$isObject = TRUE;
  P.List.$isObject = TRUE;
  W.HttpRequest.$isObject = TRUE;
  T.Move.$isObject = TRUE;
...
$.WebRequest_start_url = "http://nodejs2048-universidades.rhcloud.com/hi/start/OMEGA/json";
$.WebRequest_state_url = "http://nodejs2048-universidades.rhcloud.com/hi/state/";
...
Isolate.$lazy($, "_instance", "Game__instance", "get$Game__instance", function() {
  var t1 = new Q.Game(null, null, null, null, null, null);
  t1.Game$_internal$0();
  return t1;
});
Isolate.$lazy($, "up", "Move_up", "get$Move_up", function() {
  var t1 = new T.Move(null, null, null);
  t1._move$_value = 0;
  t1._directionX = -1;
  t1._directionY = 0;
  return t1;
});
Isolate.$lazy($, "right", "Move_right", "get$Move_right", function() {
  var t1 = new T.Move(null, null, null);
  t1._move$_value = 1;
  t1._directionX = 0;
  t1._directionY = 1;
...
Isolate.$lazy($, "down", "Move_down", "get$Move_down", function() {
  var t1 = new T.Move(null, null, null);
  t1._move$_value = 2;
  t1._directionX = 1;
  t1._directionY = 0;
...
Isolate.$lazy($, "left", "Move_left", "get$Move_left", function() {
  var t1 = new T.Move(null, null, null);
  t1._move$_value = 3;
  t1._directionX = 0;
  t1._directionY = -1;
...
function dart_precompiled($collectedClasses) {
  ...
  function GridCoordinates(x, y) {
    this.x = x;
    this.y = y;
  }
  GridCoordinates.builtin$cls = "GridCoordinates";
  if (!"name" in GridCoordinates)
    GridCoordinates.name = "GridCoordinates";
  $desc = $collectedClasses.GridCoordinates;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GridCoordinates.prototype = $desc;
  function GridIterator0(_GridIterator$_grid, _direction, _row, _cell) {
    this._GridIterator$_grid = _GridIterator$_grid;
    this._direction = _direction;
    this._row = _row;
    this._cell = _cell;
  }
  GridIterator0.builtin$cls = "GridIterator0";
  if (!"name" in GridIterator0)
    GridIterator0.name = "GridIterator0";
  $desc = $collectedClasses.GridIterator0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GridIterator0.prototype = $desc;
  ...
  ButtonNewGame.builtin$cls = "ButtonNewGame";
  if (!"name" in ButtonNewGame)
    ButtonNewGame.name = "ButtonNewGame";
  $desc = $collectedClasses.ButtonNewGame;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ButtonNewGame.prototype = $desc;
  function ButtonNewGame_closure() {
  }
  ButtonNewGame_closure.builtin$cls = "ButtonNewGame_closure";
  if (!"name" in ButtonNewGame_closure)
    ButtonNewGame_closure.name = "ButtonNewGame_closure";
  $desc = $collectedClasses.ButtonNewGame_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ButtonNewGame_closure.prototype = $desc;
  ...
  function LinkedHashMapKeyIterator(_map, _modifications, _collection$_cell, _collection$_current) {
    this._map = _map;
    this._modifications = _modifications;
  ...
  function LinkedHashSetIterator(_set, _modifications, _collection$_cell, _collection$_current) {
    this._set = _set;
    this._modifications = _modifications;
    this._collection$_cell = _collection$_cell;
    this._collection$_current = _collection$_current;
  ...
  function Game(webRequest, webRequestServer, webRequestClient, _currentGameState, _playersTurn, _listObservers) {
    this.webRequest = webRequest;
    this.webRequestServer = webRequestServer;
    this.webRequestClient = webRequestClient;
    this._currentGameState = _currentGameState;
    this._playersTurn = _playersTurn;
    this._listObservers = _listObservers;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function GameLogic(_random, _game_logic$_lastGameState, _game_logic$_listObservers) {
    this._random = _random;
    this._game_logic$_lastGameState = _game_logic$_lastGameState;
    this._game_logic$_listObservers = _game_logic$_listObservers;
  }
  GameLogic.builtin$cls = "GameLogic";
  if (!"name" in GameLogic)
    GameLogic.name = "GameLogic";
  $desc = $collectedClasses.GameLogic;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameLogic.prototype = $desc;
  function GameOverView() {
  }
  GameOverView.builtin$cls = "GameOverView";
  if (!"name" in GameOverView)
    GameOverView.name = "GameOverView";
  $desc = $collectedClasses.GameOverView;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameOverView.prototype = $desc;
  function GameSolver() {
  }
  GameSolver.builtin$cls = "GameSolver";
  if (!"name" in GameSolver)
    GameSolver.name = "GameSolver";
  $desc = $collectedClasses.GameSolver;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameSolver.prototype = $desc;
  function GameState(_game_state$_grid, _score, _points, _moves, _moved, _over, _won) {
    this._game_state$_grid = _game_state$_grid;
    this._score = _score;
  ...
  GameState.builtin$cls = "GameState";
  if (!"name" in GameState)
    GameState.name = "GameState";
  $desc = $collectedClasses.GameState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameState.prototype = $desc;
  function Grid(_grid) {
    this._grid = _grid;
  }
  Grid.builtin$cls = "Grid";
  if (!"name" in Grid)
    Grid.name = "Grid";
  $desc = $collectedClasses.Grid;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Grid.prototype = $desc;
  function GridView() {
  }
  GridView.builtin$cls = "GridView";
  if (!"name" in GridView)
    GridView.name = "GridView";
  $desc = $collectedClasses.GridView;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GridView.prototype = $desc;
  function Matrix(_array, _sizeX, _sizeY) {
    this._array = _array;
    this._sizeX = _sizeX;
    this._sizeY = _sizeY;
  }
  ...
  function Move(_move$_value, _directionX, _directionY) {
    this._move$_value = _move$_value;
